...
export const UsersForm = () => {
  ...
  const { state,setState, resource, component, updateState, add, search, sort, toggleFilter, changeView, pageChanged, pageSizeChanged } = useSearch<User, UserFilter, UserSearch>(refForm, initialState, useUser(), inputSearch());
